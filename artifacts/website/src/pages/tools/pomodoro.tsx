  ...
  return (
    <style>{`
      ...
      body.pm-light-mode {
        ...
        background-color: #fdfdfe !important;
        background-image:
          radial-gradient(ellipse 100% 60% at 50% -10%, rgba(34, 112, 93, 0.30) 0%, transparent 60%),
          radial-gradient(ellipse 55% 80% at -5% 50%, rgba(34, 112, 93, 0.45) 0%, transparent 60%),
          radial-gradient(ellipse 55% 80% at 105% 50%, rgba(34, 112, 93, 0.45) 0%, transparent 60%) !important;
