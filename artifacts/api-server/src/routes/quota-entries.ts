...
router.post("/quota-entries", async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Failed to create quota entry." });
  }
});
...
router.put("/quota-entries/:id", async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: "Failed to update quota entry." });
  }
});
...
router.delete("/quota-entries/:id", async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: "Failed to delete quota entry." });
  }
});
